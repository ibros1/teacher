...
exports.getCompletedLessons = exports.getLessonProgress = exports.markLessonProgress = void 0;
...
exports.markLessonProgress = markLessonProgress;
...
const getCompletedLessons = async (req, res) => {
    try {
        ...
        const progressPercent = courseId && totalLessons > 0 ? (completedCount / totalLessons) * 100 : 0;
        res.status(200).json({
            isSuccess: true,
